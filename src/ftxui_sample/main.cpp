...
// configuration step. It creates a namespace called `torrentinfo`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", torrentinfo::cmake::project_name, torrentinfo::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", torrentinfo::cmake::project_version);
      return EXIT_SUCCESS;
    }
